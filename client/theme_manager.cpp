...
QString ThemeManager::getThemeName(ThemeType type) const {
    switch (type) {
        case ThemeType::Default:       return "🎨 Material Design";
        case ThemeType::DarkMode:      return "🌙 Dark Mode";
        case ThemeType::RacingRed:     return "🔥 Racing Red";
        case ThemeType::Luxury:        return "💎 Luxury";
        case ThemeType::OceanBlue:     return "🌊 Ocean Blue";
        case ThemeType::PostApocalypse: return "☢️ Post-Apocalypse";
    }
    return "Unknown";
}
...
QString ThemeManager::gameCardStyle(bool selected) const {
    return QString(
     ...
     .arg(selected ? currentPalette.borderSelected : currentPalette.borderColor)
...
QString ThemeManager::progressBarStyle(const QString& fillColor) const {
    QString fill = fillColor.isEmpty() ? currentPalette.progressFill : fillColor;
