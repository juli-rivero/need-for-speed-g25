...
int main() {
    try {
        ...
        //          RaceDefinition testRace{"LibertyCity",
        ...
        //          MapLoader::loadFromYAML(testRace.mapFile, world, walls,
        //          bridges, checkpoints, hints, spawnPoints);
        //
        //          //
        //          ============================================================
        ...
        //             // Cada 2 segundos alterna entre girar a derecha e
        //             izquierda bool right = (static_cast<int>(totalTime) % 4 <
        //             2); if (right) {
