...
#include <functional>
//=====================================================================================
//  Hash y comparación para b2BodyId
//  --------------------------------
//  Box2D 3.x usa identificadores (Id structs) para mundos, cuerpos, shapes, etc.
//  Esto permite manejar la simulación en múltiples threads sin punteros directos.
//  Para poder usar estos Ids como claves de std::unordered_map, necesitamos
//  definir sus funciones hash y comparación.
// =====================================================================================
// ✅ Hash y comparación para b2BodyId (handle opaco de Box2D 3.x)
